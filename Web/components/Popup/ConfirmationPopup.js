...
const ConfirmationPopup = ({visible, title, message}) => {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const locPopup = new Modal(document.getElementById("popupModalConfirmation"), {});
